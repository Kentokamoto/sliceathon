	...
	const faqs = [
		{
			...
			description:
				`As long as you run the distance and eat the pizza, there is no wrong way to do 
				the Slice-A-Thon. If you’re feeling motivated by a challenge, aim for your half 
				marathon PR and you may win a pizza themed prize. Otherwise just relax and 
		...
		},
		{
			...
			description:
				`You'll need to pay for the slice of pizza at each checkpoint. Each slice averages 
				out to about $4.50.`
		},
		{
			title: 'How do I prove I bought pizza?',
			description:
				`After you pay for your pizza at each checkpoint, take a selfie of you eating your 
				slice with the store sign in the background`
		},
		{
		...
		},
		{
			...
			description:
				`No, we encourage people to bring their own water and will mark locations along the
				 route where people can use restrooms or find refreshments`
		},
		{
			title: 'Is this race supporting any charities? ',
			description:
				`After the race, we will give participants the chance to vote for 
		...
		},
		{
			...
			description:
				`Yes. In addition to the pizza pies, your last task in finishing the race is to 
				eat a slice of pie.`
		}
	];
